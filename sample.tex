...
\begin{paracol}{2}
\cvsection{Kinh nghiệm}


\cvevent{Nghiên cứu và Phát triển phần mềm}{Tối ưu hoá Chuỗi thời gian}{7/2024 - Hiện tại}{Đại học Bách Khoa TP.HCM}
\begin{itemize}
...
\cvevent{Vận Trù Học}{Phương pháp xử lý bài toán Tối ưu tuyến tính nguyên}{8/2023 - 5/2024}{Đại học Sài Gòn}
\begin{itemize}
...
\cvachievement{\faHeartbeat}{Đam mê cháy bổng}{Luôn yêu công việc bản thân đang làm và luôn học hỏi điều mới}

\divider

\cvachievement{\faAward}{Chill guy}{Biết cách biến mọi khó khăn và áp lực thành động lực}
